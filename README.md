...
│   ├── setup_security.py      # Security setup (runs automatically)
...
4. If token exists:
   ...
   c. If valid: Connection established
   d. If revoked: Connection rejected with suspension message
   e. If invalid: Connection rejected, client deletes token
